...
subject_name = 'Yacyuk'
directory = '.../ecog_electrodes/example/'
subjects_dir = directory+'subjects'
point_cloud_file_from_meshlab = directory+'Segmentation_Yacyuk.xyz'
...
# sort electrodes
# maybe you'll have to swape axes or change sorting order
